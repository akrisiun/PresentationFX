...
{
    public sealed class BulletChromeX : FrameworkElement
    {

        #region Constructors

        static BulletChromeX()
        {
            IsEnabledProperty.OverrideMetadata(typeof(BulletChromeX), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));
        }

        /// <summary>
        /// Instantiates a new instance of a BulletChrome with no parent element.
        /// </summary>
        public BulletChromeX()
        {
        }
