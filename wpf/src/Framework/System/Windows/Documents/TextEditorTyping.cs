        ...
        internal static void _RegisterClassHandlers(Type controlType, bool registerEventListeners)
        {
            ...
            try
            {
                ...
                CommandHelpers.RegisterCommandHandler(controlType, EditingCommands.Backspace, new ExecutedRoutedEventHandler(OnBackspace), onQueryStatusNYI, 
                    // KeyGesture.
                      CommandHelpers.CreateFromResourceStrings(SR.Get("SRID.KeyBackspace"), SR.Get("SRID.KeyBackspaceDisplayString")), KeyGesture.CreateFromResourceStrings(SR.Get("SRID.KeyShiftBackspace"), SR.Get("SRID.KeyShiftBackspaceDisplayString")));
            }
            catch { 
                // not fatal TODO
            }
