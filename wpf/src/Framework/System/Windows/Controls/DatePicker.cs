    ...
    public class DatePicker : Control
    {
        ...
        private DateTime? ParseText(string text)
        {
            ...
            try
            {
                ...
                {
                    DatePickerDateValidationErrorEventArgs dateValidationError = new DatePickerDateValidationErrorEventArgs(new ArgumentOutOfRangeException("text", 
                        SR.Get("SRID.Calendar_OnSelectedDateChanged_InvalidValue")), text);
