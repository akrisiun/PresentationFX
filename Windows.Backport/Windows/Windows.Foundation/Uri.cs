...
{
    [Activatable(typeof(IUriRuntimeClassFactory), 100794368u), DualApiPartition(version = 100794368u), MarshalingBehavior(MarshalingType.Agile), Threading(ThreadingModel.Both)]
    public sealed class Uri : IUriRuntimeClass, IUriRuntimeClassWithAbsoluteCanonicalUri
    {
        public extern string AbsoluteUri { get; }
        public extern string DisplayUri { get; }
        public extern string Domain { get; }
        public extern string Extension { get; }
        ...
        public extern WwwFormUrlDecoder QueryParsed { get; }
        public extern string RawUri { get; }
        public extern string SchemeName { get; }
        public extern bool Suspicious { get; }
        public extern string UserName { get; }
        public extern string AbsoluteCanonicalUri { get; }
        public extern string DisplayIri { get; }
