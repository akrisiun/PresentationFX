...
{
	[ExclusiveTo(typeof(Control)), Guid(1195061339u, 34685, 19509, 143, 202, 70, 160, 95, 150, 96, 122), Version(100794368u), WebHostHidden]
	internal interface IControlStatics
	{
		...
		DependencyProperty FocusStateProperty
		{
			get;
		}
		...
		DependencyProperty IsTabStopProperty
		{
			get;
		}
		...
		DependencyProperty TabIndexProperty
		{
			get;
		}
