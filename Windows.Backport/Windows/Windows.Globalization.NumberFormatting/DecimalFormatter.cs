...
{
	[Activatable(100794368u), Activatable(typeof(IDecimalFormatterFactory), 100794368u), DualApiPartition(version = 100794368u), MarshalingBehavior(MarshalingType.Agile), Threading(ThreadingModel.Both), Version(100794368u)]
	public sealed class DecimalFormatter : INumberFormatterOptions, INumberFormatter, INumberParser
	{
		...
		public extern DecimalFormatter([In] IIterable<string> languages, [In] string geographicRegion);
