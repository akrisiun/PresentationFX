...
namespace MetroDemo
{
    public partial class MainWindow
    {
...
#if ORIGIN
        public static string LIB = "Wpf.MahMetro";
#else
        public static string LIB = "Wpf.MetroLib";
#endif
        ...
        private static void ToggleUseAccentForDialogsPropertyChangedCallback(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue != e.NewValue)
            {
                ...
                metroWindow.MetroDialogOptions.ColorScheme = 
                    useAccentForDialogs ? MetroDialogColorScheme.Accented : MetroDialogColorScheme.Theme;
            }
        }
        ...
        //    //navWin.Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("pack://application:,,,/Wpf.MahMetro;component/Wpf.Styles/Clean/CleanWindow.xaml", UriKind.Absolute) });
