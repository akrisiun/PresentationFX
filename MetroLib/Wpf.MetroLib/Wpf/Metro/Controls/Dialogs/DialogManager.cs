...
namespace MahApps.Metro.Controls.Dialogs
{
    public static class DialogManager
    {
        ...
        private static Window SetupExternalDialogWindow(BaseMetroDialog dialog)
        {
            ...
            try
            {
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Wpf.Styles/Controls.xaml") });
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Wpf.Styles/Fonts.xaml") });
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Wpf.Styles/Colors.xaml") });
