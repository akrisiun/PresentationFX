...
namespace MahApps.Metro.Controls.Dialogs
{
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        {
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Wpf.Styles/Controls.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Wpf.Styles/Fonts.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Wpf.Styles/Colors.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Wpf.MetroLib;component/Themes/Dialogs/BaseMetroDialog.xaml") });
