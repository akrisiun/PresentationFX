...
namespace MahApps.Metro.Behaviours
{
    ...
    public class StylizedBehaviors
    {
        ...
        private static readonly DependencyProperty OriginalBehaviorProperty =
            ...
            typeof(Behavior), typeof(StylizedBehaviors), new UIPropertyMetadata(null));

        public static readonly DependencyProperty BehaviorsProperty = DependencyProperty.RegisterAttached(
            @"Behaviors", typeof(StylizedBehaviorCollection),
        ...
        static void OnPropertyChanged(DependencyObject dpo, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (newBehaviors != null)
            {
                ...
                if (dpo is Metro.Controls.MetroWindow)
                {
                    var w = dpo as Metro.Controls.MetroWindow;
                    w.OnAttached();
                }
            }
        }
